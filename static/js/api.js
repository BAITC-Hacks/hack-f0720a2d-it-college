...
export const api = {
  ...
  editTask: (id) => apiRequest("/tasks/" + id + "/edit"),
  ...
  confirmChanges: (id, token) => send("/tasks/" + id + "/confirm-changes", { revision_token: token }),
  ...
  progress: (id) => apiRequest("/proposals/" + id + "/progress"),
  submitProgress: (id, body) => send("/proposals/" + id + "/progress", body),
  reviewProgress: (id, stage, decision, body) => send("/proposals/" + id + "/progress/" + stage + "/" + decision, body),
};
